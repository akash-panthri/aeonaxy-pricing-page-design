...
export default function PlanElement() {
  return (
    <div className={`w-[250px] bg-[#f8f8f8] text-[#000000] h-[400px] px-3 py-7 flex flex-col justify-start  relative`}>
    ...
    <button className='rounded-[10px] w-3/4 h-[10%] border-2 border-[#1d65e2] bg-[#f8f8f8] text-[#1d65e2] absolute bottom-[12px] justify-self-center'>Get Started</button>
    </div>
  )
}
