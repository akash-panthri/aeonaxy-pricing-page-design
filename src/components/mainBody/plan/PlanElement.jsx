...
export default function PlanElement({planDatum}) {
  ...
  return (
    <div style={{background:planDatum.cardBg, color : planDatum.cardTextCol}} className={`w-[250px] m-3 h-[500px] px-3 py-7 flex flex-col justify-start border relative overflow-hidden`}>
